    ...
    <React.Fragment>
      <main className="form-signin">
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-floating">
            <label htmlFor="floatingType">Job Type: </label>
            <input
              type="text"
              name="type"
              className="form-control"
          ...
          <div className="form-floating">
            <label htmlFor="floatingType">Number of Openings: </label>
            <input
              type="number"
              name="noOfOpenings"
              className="form-control"
            ...
            />
            {touched.type && errors.noOfOpenings && (
              <div
                style={{
                  display: "block",
                }}
          ...
          <div className="form-floating">
            ...
            />
            {touched.type && errors.aboutTheJob && (
              <div
                style={{
                  display: "block",
                }}
          ...
          <div className="form-floating">
            ...
            />
            {touched.type && errors.responsibilities && (
              <div
                style={{
                  display: "block",
                }}
          ...
          <div className="form-floating">
            ...
            />
            {touched.type && errors.requirements && (
              <div
                style={{
                  display: "block",
                }}
